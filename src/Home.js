		...
		<body>
			<div className="is-boxed has-animations">
								...
								<div class="feature-inner">
									<div class="feature-icon">
										<img class="asset-light" src="dist/images/feature-01-light.svg" alt="Feature 01"></img>
											<img class="asset-dark" src="dist/images/feature-01-dark.svg" alt="Feature 01"></img>
									</div>
								...
								<div class="feature-inner">
									<div class="feature-icon">
										<img class="asset-light" src="dist/images/feature-02-light.svg" alt="Feature 02"></img>
											<img class="asset-dark" src="dist/images/feature-02-dark.svg" alt="Feature 02"></img>
									</div>
									<div class="feature-content">
							...
							<div class="feature-inner">
									<div class="feature-icon">
										<img class="asset-light" src="dist/images/feature-03-light.svg" alt="Feature 03"></img>
											<img class="asset-dark" src="dist/images/feature-03-dark.svg" alt="Feature 03"></img>
									</div>
									<div class="feature-content">
				...
				<div style={{backgroundColor: '#F0F0F0'}}>
					<MDBContainer style={{backgroundColor: '#F0F0F0'}}>
						<MDBRow>
							<MDBCol md="3"></MDBCol>
							<MDBCol md="6">
